    ...
    <div>
      ...
      >
        ...
        <div className="content-generic">
          ...
          <Image src={LeWagon} alt="Le Wagon Logo" width={300} height={100} />
          <h1 className="text-2xl text-neutral-900 font-exo font-bold">
            Le Wagon
          </h1>
          <p>
          ...
          <Image src={FinTech} alt="FinTech Bites Logo" width={100} height={100} />
          <h1 className="text-2xl text-neutral-900 font-exo font-bold">
            FinTech Bites
          </h1>
          <p>
